//
//  SideMenuMerchantViewController.swift
//  PaymentsApp
//
...
class SideMenuMerchantViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {

   @IBOutlet weak var tableView: UITableView!
      
      var items = ["Home", "Bank Accounts", "Registered Devices", "Settings", "Contact Us", "Log Out"]
      ...
      func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
          let cell = tableView.dequeueReusableCell(withIdentifier: "side_menu_merchant_options", for: indexPath)
      ...
      func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 2: NotificationCenter.default.post(name: NSNotification.Name("ShowRegisteredDevices"), object: nil)
