...
class VerifyPINCodeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func confirmButtonPressed() {
        ...
        if otpTextField1.text == "" || otpTextField2.text == "" || otpTextField3.text == "" || otpTextField4.text == "" {
            ...
            if let pinCreated = UserDefaults.standard.string(forKey: "pin") {
                if pin == pinCreated {
                    performSegue(withIdentifier: "pin_verified", sender: nil)
                } else {
